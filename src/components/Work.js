...
const Work = () => {
    ...
    const openDesc = ()=>{
        //e.target.nextSibling.className = 'main-work-wrapper--open'
        ...
        setdescription({
            ...
            childClassFive: 'std-text--black std-text--link work-wrapper_desc--show-five',
            childClassSix: 'std-text--black std-text--link work-wrapper_desc--show-six'
        })
    }
    ...
    const openDesc2 = ()=>{
        //e.target.nextSibling.className = 'main-work-wrapper--open'
        setdescription({ mainClass: 'main-work-wrapper',  mainFuction: openDesc });
        setdescription3({ mainClass: 'main-work-wrapper',  mainFuction: openDesc3 });
        setdescription4({ mainClass: 'main-work-wrapper',  mainFuction: openDesc4 })
...
const closeDesc3 =  () =>{
    ...
    return (
        <div className = 'work-wrapper'>
            {/*============= LINK ONE =========*/}
            <div className="std-text work-wrapper_work" onClick = { description.mainFuction }>xolproperties.com</div>
            <div className = {description.mainClass}>
                <div className="work-wrapper_border">
                    <h3 className= 'std-text--black'>Techonologies Used</h3>
                    <div className = {description.childClassOne}><div className = 'work-wrapper_svg'></div>HBS</div>
                    <div className = {description.childClassTwo}><div className = 'work-wrapper_svg'></div>Node.js</div>
             ...
             {/*============= LINK TWO =========*/}
            <div className="std-text work-wrapper_work" onClick = { description2.mainFuction }>xharcoal.com</div>
            <div className = {description2.mainClass}>
                <div className="work-wrapper_border">
                    <h3 className= 'std-text--black'>Techonologies Used</h3>
                    <div className = {description2.childClassOne}><div className = 'work-wrapper_svg'></div>MongoDb</div>
             ...
             {/*============= LINK THREE =========*/}
            <div className="std-text work-wrapper_work" onClick = { description3.mainFuction }>rangeledamiracle.com</div>
            <div className = {description3.mainClass}>
                <div className="work-wrapper_border">
                    <h3 className= 'std-text--black'>Techonologies Used</h3>
                    <div className = {description3.childClassOne}><div className = 'work-wrapper_svg'></div>HTML</div>
                    <div className = {description3.childClassTwo}><div className = 'work-wrapper_svg'></div>CSS</div>
            ...
            {/*============= LINK FOURTH =========*/}
            <div className="std-text work-wrapper_work" onClick = { description4.mainFuction }>savvysaute.com</div>
            <div className = {description4.mainClass}>
                <div className="work-wrapper_border">
                    <h3 className= 'std-text--black'>Techonologies Used</h3>
                    <div className = {description4.childClassOne}><div className = 'work-wrapper_svg'></div>EJS</div>
                    <div className = {description4.childClassTwo}><div className = 'work-wrapper_svg'></div>SASS</div>
